 ...
 */
package ListaSeleccionMultiple;
...
public class MarcoSeleccionMultiple extends JFrame{
    private final JList<String> listaJListColores; //  lista para guardar los nombresde los colores
    ...
    public MarcoSeleccionMultiple(){
        ...
        add(botonJButtonCopiar); // agrega el botón copiar a JFrame50
