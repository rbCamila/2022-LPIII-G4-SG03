...
public class MarcoBotonOpcion extends JFrame {
    ...
    private ButtonGroup grupoOpciones; // contiene los botones de opción24
    ...
    public MarcoBotonOpcion() 
    {
        ...
        campoTexto = new JTextField("Camila Rodriguez Brown | Elmer Hanccoccallo", 28);
